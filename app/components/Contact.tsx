            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:mahendraadodi@gmail.com" className="text-gray-400 hover:text-blue-400 transition-colors">
                    mahendraadodi@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Pontianak, Indonesia</p>
                </div>
              </div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full px-8 py-3 text-base font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition-colors duration-300 transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed"
              >
